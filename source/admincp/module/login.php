...
function CheckLogin(){
	if(document.form.adminname.value==""){
	        ...
	        return false;
	<?php if(IN_CODEOPEN){ ?>	}else if(document.form.code.value==""){
...
<tr>
	...
	<td>
		...
		<?php } ?>		<p class="loginnofloat"><input name="form" value="提交" type="submit" class="btn" onclick="return CheckLogin()"></p>
		</form>
	</td>
</tr>
</table>
