...
<div class="mainhd">
<a href="?iframe=index" class="logos">  快兔科技二开分发</a>
...
<li><a href="?iframe=config_pay" hidefocus="true" target="main"><em onclick="menuNewwin(this)" title="新窗口打开"></em>支付配置</a></li>
<li><a href="?iframe=config_credit" hidefocus="true" target="main"><em onclick="menuNewwin(this)" title="新窗口打开"></em>业务配置</a></li>
<li><a href="?iframe=config_upload" hidefocus="true" target="main"><em onclick="menuNewwin(this)" title="新窗口打开"></em>上传配置</a></li>
...
<li><a href="?iframe=key" hidefocus="true" target="main"><em onclick="menuNewwin(this)" title="新窗口打开"></em>签名密钥</a></li>
<li><a href="?iframe=cert" hidefocus="true" target="main"><em onclick="menuNewwin(this)" title="新窗口打开"></em>证书管理</a></li>
<li><a href="?iframe=sign" hidefocus="true" target="main"><em onclick="menuNewwin(this)" title="新窗口打开"></em>签名管理</a></li>
<li><a href="?iframe=allsign" hidefocus="true" target="main"><em onclick="menuNewwin(this)" title="新窗口打开"></em>批量重签</a></li>
<li><a href="?iframe=kong" hidefocus="true" target="main"><em onclick="menuNewwin(this)" title="新窗口打开"></em>签名控制</a></li>
<li><a href="?iframe=secret" hidefocus="true" target="main"><em onclick="menuNewwin(this)" title="新窗口打开"></em>授权管理</a></li>
</ul>
...
setMenuScroll();}
var header_key=initCpMenus('leftmenu');toggleMenu(header_key?header_key:'index');function initCpMap(){var ul,hrefs,s='',count=0;for(var k in headers){if(headers[k]!='index'&&headers[k]!='app'&&$('header_'+headers[k])){s+='<tr><td valign="top"><h4>'+$('header_'+headers[k]).innerHTML+'</h4></td><td valign="top">';ul=$('menu_'+headers[k]);if(!ul){continue;}
