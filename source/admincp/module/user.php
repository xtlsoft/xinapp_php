...
<?php if(empty($action)){?>
<script type="text/javascript">
  parent.document.title = 'EarCMS Board 管理中心 - 用户 - 所有用户 ';
...
<?php 
  ...
  if($action=="lock"){?>
<script type="text/javascript">
  parent.document.title = 'EarCMS Board 管理中心 - 用户 - 锁定状态';
...
?> 
<script type="text/javascript">
  parent.document.title = 'EarCMS Board 管理中心 - 用户 - 待审认证 '; 
...
<?php
  ...
  if($action=="keyword"){ ?>
<script type="text/javascript">
  parent.document.title = 'EarCMS Board 管理中心 - 用户 - 搜索用户';
