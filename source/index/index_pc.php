...
<link rel="stylesheet" href="<?php echo IN_PATH;?>index/css/main.css" /> 
<script src="<?php echo IN_PATH;?>index/js/jquery.min.js"></script>
<script src="<?php echo IN_PATH;?>index/js/bootstrap.min.js"></script>
<script src="<?php echo IN_PATH;?>index/js/vue.js"></script>
<script src="<?php echo IN_PATH;?>index/js/js.js"></script>
<script src="<?php echo IN_PATH;?>index/js/swiper.min.js"></script>
<script src="<?php echo IN_PATH;?>index/js/vue-countup.min.js"></script>
<script>        
	isHideFooter = false;
</script>
</head>
...
<a href="/index.php/publish" class="hidden-xs" style="background: url(<?php echo IN_PATH;?>index/img/index-banner-1.jpg) no-repeat center;">
<div class="container">
...
<div class="swiper-slide">
<a href="#" class="hidden-xs" style="background: url(<?php echo IN_PATH;?>index/img/index-banner-3.jpg) no-repeat center;" class="clearfix">
<div class="container">
...
<a href="#" class="hidden-xs" style="background: url(<?php echo IN_PATH;?>index/img/index-banner-2.jpg) no-repeat center;">
<div class="container">
...
<a href="#" class="hidden-xs" style="background: url(<?php echo IN_PATH;?>index/img/index-banner-4.jpg) no-repeat center;" class="clearfix">
<div class="container">
...
<a class="ms-btn ms-btn-secondary ms-btn-lg" href="/index.php/home">立即签名</a>
</div>
</div>
