	...
	<div class="form-inner">
		<form class="form-float-label" onsubmit="reg();return false">
			...
			<div class="form-group form-group-sign-code">
				...
				<button type="button" class="btn btn-primary btn-get-sign-code" id="send_btn" onclick="sends_mail()">获取邮件码</button>
			</div>
			-->
			<div class="form-group">
			...
			<div class="form-group form-group-sign-code">
				...
				<img id="img_seccode" onclick="update_seccode()" style="margin:4px;border-radius:4px;cursor:pointer" src="<?php echo IN_PATH.'source/index/seccode.php'; ?>" height="46">
			</div>
