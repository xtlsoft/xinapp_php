                    ...
                    <div class="page-tabcontent apps-app-info">
                        <div class="middle-wrapper">
                            <div class="app-info-form">
                                <div class="field app-name">
                                    <div class="value">
                                        ...
                                        <input type="radio" name="mc_type" onclick="change(0)" >&nbsp;标准ios封装&nbsp;&nbsp;
                                        <input type="radio" name="mc_type" onclick="change(1)">&nbsp;苹果免签封装（不掉永久使用）
                            ...
                            <div class="app-info-form" id="webview">
                                ...
                                <div class="field app-name">
                                    <div class="value">
                                        <input type="text" placeholder="域名地址" id="in_url"
                                ...
                                <div class="field app-short">
                                    <div class="value">
                                        <div class="apps-app-security" id="preview_a_icon">
                                            <input type="file" id="upload_a_icon" onchange="upload_a_icon()"
                                                   style="display:none">
                                            <div class="btn-invite-member" id="tips_a_icon"
                                                 onclick="$('#upload_a_icon').click()">上传应用图标
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="field app-short">
                                    <div class="value">
                                        <div class="apps-app-security" id="preview_l_image">
                                            <input type="file" id="upload_l_image" onchange="upload_l_image()"
                                                   style="display:none">
                                            <div class="btn-invite-member" id="tips_l_image"
                                                 onclick="$('#upload_l_image').click()">上传启动图片
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="app-info-form" id="mobileconfig" style="display:none">
                                ...
                                <div class="field app-name">
                                    <div class="value">
                                        <input type="text" placeholder="域名地址" id="mc_url"
                                               onkeyup="if(!value.match(/^https?:///)){value='http://'+value}"
                                               onblur="if(!value.match(/^https?:///)){value='http://'+value}">
                                    </div>
                                </div>
                                <div class="field app-short">
                                    <div class="value">
                                        <div class="apps-app-security" id="preview_mc_a_icon">
                                            <input type="file" id="upload_mc_a_icon" onchange="upload_mc_a_icon()"
                                                   style="display:none">
                                            <div class="btn-invite-member" id="tips_mc_a_icon"
                                                 onclick="$('#upload_mc_a_icon').click()">上传应用图标
                                            </div>
                                        </div>
                                    </div>
                                </div>
