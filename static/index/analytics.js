(function() {
	...
	var oc = function() {
			return (Ba || "https:" == M[B][E] ? "https:" : "http:") + "//ga.fir.im"
		},
		Da = function(a) {
			fa(this, "len");
			this.message = a + "-8192"
			...
			if (d.g) Yd.set(d.a[0], d.a[1]);
				...
				if (d.i) {
					...
					if (!ea(Yd.get(g)) && !$d.get(g)) {
						...
						if (ca) {
							ca && 0 <= ca[t]("/") || (ca = (Ba || "https:" == M[B][E] ? "https:" : "http:") + "//ga.fir.im/plugins/ua/" + ca);
							var l = ae(ca),
								e = void 0;
							var k = l[E],
								w = M[B][E],
							...
							if (Xd = e) {
								...
								if (e.G || 0 <= e.url[t]("?") || 0 <= e.path[t]("://")) Xd = !1;
									...
									Xd = "ga.fir.im" == e[x] && (e[ja] || ce) == ce && D(e.path, "/plugins/") ? !0 : !1
								}
							}
	...
	$.remove = function(a) {
		for (var b = 0; b < $.P[y]; b++) if ($.P[b].get(V) == a) {
			$.P.splice(b, 1);
			$.h[a] = null;
			break
		}
	...
	$.N = function() {
		...
		if (!a || 42 != a.answer) {
			...
			t: for (var b = M.getElementsByTagName("script"), c = 0; c < b[y] && 100 > c; c++) {
				var d;
				d = (d = b[c].src) ? 0 != d[t]("https://ga.fir.im/analytics") ? !1 : !0 : !1;
				if (d) {
					J(33);
					break t
				}
			}
			"https:" != M[B][E] && !Ba && Ed() && (J(36), Ba = !0);
