...
(function () {
    ...
    var w = {
        zh: {
            ...
            REALNAME_LAYER_CONTENT: "建议您：<br>尽快登录富贵分发网站，点击右上角未实名认证，进行认证。<br>未实名认证，下载链接有效期只有24小时，只能下载5次。",
        ...
        en: {
            ...
            REALNAME_LAYER_CONTENT: "please go to login to linkeyun website，click the button in the upper right corner to authentication。<br />If not , the download link is valid for download only 5 times in 24 hours.",
        ...
        "zh-tw": {
            ...
            REALNAME_LAYER_CONTENT: "建議您：<br>盡快登錄富貴分發網站，點擊右上角未實名認證，進行認證。<br>未實名認證，下載鏈接有效期只有24小時，只能下載5次。",
            REALNAME_LAYER_BUTTON_TEXT: "知道了",
            BUTTON_OK: "確定"
        }
    };
